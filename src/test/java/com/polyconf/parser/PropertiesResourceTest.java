...
class PropertiesResourceTest extends ResourceTestBase {
    ...
    void database() {
        ...
        assertEquals("5", f.get("db.pool.min"));
        assertEquals("20", f.get("db.pool.max"));
        assertEquals("30000", f.get("db.pool.timeout"));
    ...
    void logging() {
        ...
        assertEquals("5", f.get("log.file.max-backups"));
    ...
    void gradle() {
        ...
        assertEquals("17", f.get("sourceCompatibility"));
        assertEquals("17", f.get("targetCompatibility"));
    }
